...
var file_plugin_api_proto_rawDesc = []byte{
	...
	0x9d, 0x02, 0x0a, 0x0d, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5a, 0x0a, 0x09, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62,
	...
	,
...
type PluginControlClient interface {
	...
	Heartbeat(ctx context.Context, opts ...grpc.CallOption) (PluginControl_HeartbeatClient, error)
...
func (c *pluginControlClient) Heartbeat(ctx context.Context, opts ...grpc.CallOption) (PluginControl_HeartbeatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PluginControl_serviceDesc.Streams[0], "/systemapi_plugin.PluginControl/Heartbeat", opts...)
	if err != nil {
		return nil, err
	}
	x := &pluginControlHeartbeatClient{stream}
	return x, nil
}

type PluginControl_HeartbeatClient interface {
	Send(*HeartbeatRequest) error
	Recv() (*HeartbeatResponse, error)
	grpc.ClientStream
}

type pluginControlHeartbeatClient struct {
	grpc.ClientStream
}

func (x *pluginControlHeartbeatClient) Send(m *HeartbeatRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pluginControlHeartbeatClient) Recv() (*HeartbeatResponse, error) {
...
func (c *pluginControlClient) CommandChannel(ctx context.Context, opts ...grpc.CallOption) (PluginControl_CommandChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PluginControl_serviceDesc.Streams[1], "/systemapi_plugin.PluginControl/CommandChannel", opts...)
	if err != nil {
		return nil, err
	}
...
type PluginControlServer interface {
	...
	Heartbeat(PluginControl_HeartbeatServer) error
...
func (*UnimplementedPluginControlServer) Heartbeat(PluginControl_HeartbeatServer) error {
...
func _PluginControl_Heartbeat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PluginControlServer).Heartbeat(&pluginControlHeartbeatServer{stream})
}

type PluginControl_HeartbeatServer interface {
	Send(*HeartbeatResponse) error
	Recv() (*HeartbeatRequest, error)
	grpc.ServerStream
}

type pluginControlHeartbeatServer struct {
	grpc.ServerStream
}

func (x *pluginControlHeartbeatServer) Send(m *HeartbeatResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pluginControlHeartbeatServer) Recv() (*HeartbeatRequest, error) {
