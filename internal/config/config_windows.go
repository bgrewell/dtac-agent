...
const (
	GLOBAL_CONFIG_LOCATION = "c:\\Program Files\\Intel\\dtac-agent\\"
...
var (
	...
	DEFAULT_BINARY_LOCATION = path.Join(GLOBAL_CONFIG_LOCATION, "bin\\")
	DEFAULT_PLUGIN_LOCATION = path.Join(GLOBAL_CONFIG_LOCATION, "plugins\\")
